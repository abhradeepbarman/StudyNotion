  ...
  return (
    <div  className='text-white'>
        ...
        <section className='bg-richblack-700'>
            ...
            <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                    ...
                    <p className="mx-auto mt-3 text-center text-base font-semibold text-richblack-300 lg:w-[95%]">
        ...
        <section className="border-b border-richblack-700">
            <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white text-4xl">
        ...
        <section>
            ...
            <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
                ...
                <div className="flex flex-col items-center gap-20 lg:flex-row justify-between">
                    ...
                    <div className='lg:w-[50%] my-24 flex flex-row-reverse'>
                ...
                <div className="flex flex-col items-center gap-10 lg:flex-row justify-between ">
                    ...
                    {/* right box  */}
                    <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                        <div className='text-4xl semibold'>
