...
function CourseDetails() {
    ...
    //declare state variable to store course details
    ...
    useEffect(() => {
        const count = getAverageRating(response?.data?.courseDetails?.ratingAndReviews)
            ...
            <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
                <div  className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
                    ...
                    <div className={`z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-richblack-5`}>
                        ...
                        <div className="flex flex-wrap gap-5 text-lg">
                            <p className="flex items-center gap-2">
                                {" "}
                                <BiInfoCircle /> Create at {formattedDate(createdAt)}
                            </p>
                    ...
                    <div className="flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden">
                        ...
                        <button className='cursor-pointer rounded-md bg-yellow-50 px-[20px] py-[8px] font-semibold text-richblack-900'>
                            Buy Now
                        </button>
